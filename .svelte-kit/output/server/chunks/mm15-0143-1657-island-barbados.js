...
const Mm15_0143_1657_island_barbados = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
<p>Having lost his fortune during the English Civil Wars, Richard Ligon (1585?-1662) left England in 1648 to gain his fortune in the New World where he spent two years on the Caribbean island of Barbados, one of America’s most profitable colonies in the sugar trade. While the narrative of Ligon’s <em>History</em> (1657) traced the triangular trade (consisting of English goods, slaves, and sugar), his large foldout map concentrated on the island itself. A reproduction of Captain John Swan’s 1638 map, Ligon’s version continued to identify nearly three hundred plantations by their owners’ names, the majority of which were located along the island’s coast. </p>
<p>Drawn in a pictographic style that echoed Smith’s map of New England, Ligon’s map suggested limited mobility within the island’s interior, which the map rendered optically inaccessible by showing forests, mountains, and wild beasts. Strategically placed vignettes depict planters hunting wild pigs or chasing runaway slaves. Surprisingly, Ligon also inserted a pair of camels on which he commented that “these are very useful beasts, but very few will live upon the Island; divers [planters] have had them brought over, but few know how to diet them.” Showing the lack of waterways or developed road systems, the map’s inclusion of images depicting four different types of sailing vessels reminded readers that the sea rather than land offered the better path of transportation.</p>`;
});
export {
  Mm15_0143_1657_island_barbados as default,
  metadata
};
