...
import { x, s as scrollPoint, y, m as maxX, t as toc, a as showSidebar } from "../../chunks/stores.js";
const openProps_min = "";
const normalize_min = "";
const main = "";
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `
<header class="${"wedgie " + escape($y > 45 ? "shadow" : "", true) + " svelte-l8x4hq"}"><div class="logo"><a href="https://www.newberry.org" target="_blank" class="linklogo" aria-label="Link to Newberry Library's home page">${validate_component(Newberry, "Newberry").$$render($$result, {}, {}, {})}</a></div>
...
const Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<ul class="side bar svelte-1oeavll"><a href="${"/" + escape(base, true)}" class="${escape(
    ...
    true
  ) + " svelte-1oeavll"}"><li>Home</li></a>
    ${each(toc, (c) => {
    return `<a href="${"/" + escape(c.essayslug, true)}" class="${escape(
      null_to_empty($page.url.pathname !== "/" && $page.url.pathname.indexOf(c.essayslug) > -1 ? "active no-lines" : "no-lines"),
      true
    ) + " svelte-1oeavll"}"><li>${escape(c.essaytitle)}</li>
        </a>`;
  })}
</ul>`;
});
...
const css$2 = {
  code: "footer.svelte-hulqv0.svelte-hulqv0{position:absolute;bottom:0;left:0;right:0;width:100%;min-height:50px;background-color:var(--granite)}.flex-wrapper.svelte-hulqv0.svelte-hulqv0{display:flex;flex-direction:column;align-items:center;justify-content:space-between;margin:auto}.left-border.svelte-hulqv0.svelte-hulqv0{border-left:1px solid rgba(var(--midnight-rgb), 0.77);padding-left:8px}.left.svelte-hulqv0.svelte-hulqv0,.right.svelte-hulqv0.svelte-hulqv0{margin-block:4px}.left.svelte-hulqv0.svelte-hulqv0{flex:1;display:flex;align-items:center;justify-content:center}.right.svelte-hulqv0.svelte-hulqv0{flex:3;padding-left:11px}footer.svelte-hulqv0.svelte-hulqv0,footer.svelte-hulqv0 a.svelte-hulqv0{line-height:13px;font-family:'styrene';padding-block:0;font-size:11px;color:rgba(var(--midnight-rgb), 0.77);text-decoration:none;transition:100ms}a.svelte-hulqv0.svelte-hulqv0:visited{color:rgba(var(--sapphire-rgb), 0.87)}a.svelte-hulqv0.svelte-hulqv0:hover,a.svelte-hulqv0.svelte-hulqv0:active{color:rgba(var(--mulberry-rgb), 0.87)}",
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<footer class="svelte-hulqv0"><div class="flex-wrapper svelte-hulqv0"><div class="left svelte-hulqv0"><a href="https://www.newberry.org/" target="_blank" class="svelte-hulqv0">The Newberry</a>
			<a href="https://www.newberry.org/contact-librarian" class="left-border svelte-hulqv0" target="_blank">Contact Us
			</a></div>
		<div class="right svelte-hulqv0">Except where otherwise noted, contextual content on this site is made available under a
			<a href="https://creativecommons.org/share-your-work/public-domain/cc0/" target="_blank" class="llines svelte-hulqv0">Creative Commons Public Domain license
			...
			<a href="https://www.newberry.org/policies#open-access" target="_blank" class="llines svelte-hulqv0">Newberry Open Access Policy
			</a>.
		</div></div>
</footer>`;
});
...
<main class="${["svelte-1csfp38", visible ? "visible" : ""].join(" ").trim()}"><nav class="svelte-1csfp38">${validate_component(Sidebar, "Sidebar").$$render($$result, {}, {}, {})}</nav>
...
<button class="sidebar-button svelte-1csfp38" aria-label="Show sidebar">${validate_component(Icon, "Icon").$$render($$result, { icon: "gg:menu-round", width: 32 }, {}, {})}</button>
