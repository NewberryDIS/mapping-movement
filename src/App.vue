  ...
  .container(v-if="$route.path === '/'")
    h1
      router-link.logo-link(to="/")
        span Mapping Movement <span style="white-space: nowrap">in American History and Culture</span>
  .container.-wide(v-else)
    nav.nav
      router-link.logo-link(to="/") Mapping Movement

      ul(v-if="$route.path.startsWith('/essays') || $route.path.startsWith('/maps')")
...
footer.footer
  .wide
    .row
      .col
        p Newberry Library is basically tippy top when it comes to libarrys
      .col
        hr
...
<style lang="scss">
        ...
        // <link rel="stylesheet" href="https://fast.fonts.net/cssapi/fc8f8385-7e78-4c4b-a85e-9fa8bb57a66a.css">
@import 'https://fast.fonts.net/cssapi/fc8f8385-7e78-4c4b-a85e-9fa8bb57a66a.css';
@import 'reset-css';
