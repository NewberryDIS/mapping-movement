<script>
	...
	// console.log("wheres my footer")
</script>

<footer>
	<div class="flex-wrapper">
		<div class="left">
			<a href="https://www.newberry.org/" target="_blank">The Newberry</a>
			<a href="https://www.newberry.org/contact-librarian" class="left-border" target="_blank">
				Contact Us
			</a>
		</div>
		<div class="right">
...
<style>
	...
	.left-border {
		border-left: 1px solid rgba(var(--midnight-rgb), 0.5);
		padding-left: 8px;
	}
	.left,
	.right {
	...
	footer a {
		...
		padding-block: 0;
		font-size: 11px;
		color: rgba(var(--midnight-rgb), 0.5);
	...
	a:hover,
	a:active {
		color: rgba(var(--mulberry-rgb), 0.75);
	}
</style>
